...
* 1.7.3 - 2025.09.23 iOS26适配优化，导航栏高度优化
* 1.7.1 - 2025.09.22 适配iOS26，修复设置导航栏透明度闪烁问题
* 1.6.9 - 2025.07.16 修复pop返回后导航栏item位置偏移问题
* 1.6.8 - 2025.05.27 修复pop时可能出现黑边的情况
* 1.6.7 - 2025.01.20 导航栏适配最新机型
