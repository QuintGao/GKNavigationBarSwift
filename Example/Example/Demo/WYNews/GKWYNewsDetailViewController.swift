...
class GKWYNewsDetailViewController: GKTabBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let pageImage = UIImageView(frame: CGRect(x: 0, y: GKDevice.statusBarNavBarHeight(), width: GK_SCREEN_WIDTH, height: GK_SCREEN_HEIGHT - GKDevice.statusBarNavBarHeight()))
